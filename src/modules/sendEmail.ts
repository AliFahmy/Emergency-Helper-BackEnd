...
class sendEmail {
    ...
    public async sendRegistrationMail(name:string,token:string,email:string,role:string):Promise<boolean>{
            const url = `https://emergency-helper.herokuapp.com/api/Account/VerifyAccount/${token}/${role}`;
